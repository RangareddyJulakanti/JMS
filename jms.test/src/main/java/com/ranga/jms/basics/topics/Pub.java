...
public class Pub {
	// URL of the JMS server. DEFAULT_BROKER_URL will just mean that JMS server is
		...
		private static String subject = "JCG_TOPIC"; // Queue Name.You can create any/many queue names as per your
														// requirement.
		...
		public static void main(String[] args) throws JMSException {
			...
			// Destination represents here our queue 'JCG_TOPIC' on the JMS server.
